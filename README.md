...
- Полный цикл работы приложения (Controller → Service → Repository)
- Использование Testcontainers для поднятия PostgreSQL
- Тестирование реального взаимодействия с БД без моков
- Проверка корректности работы Spring Boot контекста
